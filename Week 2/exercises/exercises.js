...
alert(
  "Welcome to 'Exercise 1:Grade calculator'. Please press OK button to proceed."
);
...
alert(
  "Welcome to 'Exercise 2: Print Numbers in Range'. Please press OK button to proceed."
);
let highestGrade = prompt("Enter highest Grade: ");
let lowestGrade = prompt("Enter lowest Grade: ");
if (lowestGrade > highestGrade) {
  console.log(
    "ERROR! First value should greater than second one. Please refresh your page."
  );
} else {
...
alert(
  "Welcome to 'Exercise 3: Calculate Power'. Please press OK button to proceed."
);
